        ...
        <div class="grid lg:grid-cols-12 sm:grid-col-2 md:grid-cols-3 gap-4 bg-blue-600">
          ...
          <div class="grid grid-rows-3 grid-flow-col gap-4 mt-4">
            ...
            <div class="row-span-2 col-span-2 ...">
                <form action="<?php echo e(route('create')); ?>" method="post" class="">
                    <?php echo csrf_field(); ?>
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="currency_name" type="text" name="currency_name" placeholder="Example : Dollar">
                      ...
                      <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="currency_code" type="text" name="currency_code" placeholder="Example : $">
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\currency-app\resources\views/create.blade.php ENDPATH**/ ?>