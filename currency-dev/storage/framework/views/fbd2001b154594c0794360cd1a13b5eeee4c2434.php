<!doctype html>
    ...
    <body>
            ...
            <div class="row">
                ...
                <?php echo $__env->make('layout.partials._content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
                <?php echo $__env->make('layout.partials._scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\ticket-support\resources\views/layout\main.blade.php ENDPATH**/ ?>